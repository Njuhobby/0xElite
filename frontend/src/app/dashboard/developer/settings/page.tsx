    ...
    <div className="max-w-3xl">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-6">
        ...
        <div className="space-y-0 divide-y divide-gray-100">
          ...
          {/* Availability Status */}
          <div className="py-4">
            <p className="text-sm font-medium text-gray-900 mb-1">Availability Status</p>
            <p className="text-gray-500 text-sm mb-3">
              Control your availability for new project assignments. You can update this from your profile.
            </p>
            <div className="flex gap-2">
              <span className="px-3 py-1.5 bg-green-50 border border-green-200 rounded-lg text-green-700 text-sm font-medium">
                Available
              </span>
              <span className="px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-lg text-gray-400 text-sm">
                Busy
              </span>
              <span className="px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-lg text-gray-400 text-sm">
                Vacation
          ...
          <div className="py-4">
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3 cursor-not-allowed opacity-50">
                ...
                <span className="text-gray-700 text-sm">New project assignments</span>
              </label>
              <label className="flex items-center gap-3 cursor-not-allowed opacity-50">
                <input type="checkbox" disabled className="w-4 h-4 rounded border-gray-300 text-violet-600" />
                <span className="text-gray-700 text-sm">Project updates</span>
              </label>
              <label className="flex items-center gap-3 cursor-not-allowed opacity-50">
                <input type="checkbox" disabled className="w-4 h-4 rounded border-gray-300 text-violet-600" />
                <span className="text-gray-700 text-sm">Payment notifications</span>
              </label>
            </div>
          </div>
        </div>
