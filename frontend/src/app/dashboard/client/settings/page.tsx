          ...
          <div className="py-4">
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3 cursor-not-allowed opacity-50">
                ...
                <span className="text-gray-300">Milestone submissions</span>
              </label>
              <label className="flex items-center gap-3 cursor-not-allowed opacity-50">
                <input type="checkbox" disabled className="w-5 h-5 rounded border-white/20" />
                <span className="text-gray-300">Project status changes</span>
              </label>
              <label className="flex items-center gap-3 cursor-not-allowed opacity-50">
                <input type="checkbox" disabled className="w-5 h-5 rounded border-white/20" />
                <span className="text-gray-300">Escrow updates</span>
              </label>
            </div>
          </div>
        </div>
